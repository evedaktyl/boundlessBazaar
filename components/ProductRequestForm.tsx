      ...
      const handleSubmit = async (event:any) => {
        ...
        try {
          ...
          if (response.ok) {
            ...
            router.push('/ProductRequestPage/SuccessfulRequest');
          } else {
          ...
          <div className='bg-rose-100'>
            <Row className="max-w-7xl px-20 grid grid-cols-2">
              ...
              <Col className='pt-20 pl-32'>
                <Row className='grid grid-cols-3 text-black'>
                  <div className='pb-10'>
                ...
                <div className='pb-10 text-black'>
                  ...
                  <input className='w-96 text-black rounded' name="productDetails" value={formData.productDetails} onChange={handleChange} />
                </div>
                <Row className='grid grid-cols-2'>
                  <div className='pb-10 text-black'>
                    <h1>Quantity</h1>
                    <input className='w-44 text-black rounded' type="number" name="quantity" value={formData.quantity} onChange={handleChange} />
                  </div>
                  <div className='pl-10 pb-10 text-black'>
                    <h1>Your Offer (USD)</h1>
                    <input className='w-44 text-black rounded' type="number" name="yourOffer" value={formData.yourOffer} onChange={handleChange} />
                  </div>
                </Row>
              </Col>
            </Row>
              ...
              <Col className='pt-20 pl-32'>
                ...
                <Row className='grid grid-cols-3 text-black'>
                  ...
                  <div className='pl-20 pb-10'>
                    <h1>Delivery City</h1>
                    <input className='w-32 text-black rounded' name="deliveryCity" value={formData.deliveryCity} onChange={handleChange} />
                  </div>
                </Row>
                <div className='pb-10 text-black'>
...
//changed form titles to black - was not visible on my side
export default function ProductRequestForm() {
  const session:any = useSession();
  const router = useRouter();
  const [formData, setFormData] = useState({
      ...
      <form onSubmit={handleSubmit}>
        <div className=' bg-rose-100'>
          <Row className="max-w-7xl px-20 grid grid-cols-2">
            ...
            <Col className='pt-20 pl-32 text-black'>
              <Row className='grid grid-cols-3'>
                <div className='pb-10'>
                  <h1>Product Country</h1>
                  <input className=' w-36 rounded' name="productCountry" value={formData.productCountry} onChange={handleChange} />
                </div>
                <div className='pl-4 pb-10'>
                  <h1>Product State</h1>
                  <input className='w-36 rounded' name="productState" value={formData.productState} onChange={handleChange} />
                </div>
                <div className='pl-8 pb-10'>
                  <h1>Product City</h1>
                  <input className='w-32 rounded' name="productCity" value={formData.productCity} onChange={handleChange} />
                </div>
              </Row>
              <div className='pb-10'>
                <h1>Enter Product Web URL (Optional)</h1>
                <input className='w-[450px] rounded' name="productURL" value={formData.productURL} onChange={handleChange} />
              </div>
              <div className='pb-10'>
                <h1>Enter Image URL (Optional) </h1>
                <input className='w-[450px] rounded' name="imageURL" value={formData.imageURL} onChange={handleChange} />
              </div>
              <div className='pb-10'>
                <h1>Product Name</h1>
              ...
              <div className='pb-10'>
                <h1>Product Details</h1>
                <input className='w-96 rounded' name="productDetails" value={formData.productDetails} onChange={handleChange} />
              </div>
              <Row className='grid grid-cols-2'>
                <div className='pb-10'>
                  <h1>Quantity</h1>
                  <input className='w-44 rounded' type="number" name="quantity" value={formData.quantity} onChange={handleChange} />
                </div>
                <div className='pl-10 pb-10'>
                  <h1>Your Offer (USD)</h1>
                  <input className='w-44 rounded' type="number" name="yourOffer" value={formData.yourOffer} onChange={handleChange} />
                </div>
              </Row>
            </Col>
          </Row>
      <Row className="max-w-7xl px-20 grid grid-cols-2 pt-20">
        ...
        <Col className='pt-20 pl-32 text-black'>
          ...
          <Row className='grid grid-cols-3'>
            <div className='pb-10'>
              <h1>Delivery Country</h1>
              <input className='w-32 rounded' name="deliveryCountry" value={formData.deliveryCountry} onChange={handleChange} />
            </div>
            <div className='pl-5 pb-10'>
              <h1>Delivery State</h1>
              <input className='w-32 rounded' name="deliveryState" value={formData.deliveryState} onChange={handleChange} />
            </div>
            <div className='pl-10 pb-10'>
              <h1>Delivery City</h1>
              <input className='w-32 rounded' name="deliveryCity" value={formData.deliveryCity} onChange={handleChange} />
            </div>
          </Row>
          <div className='pb-10'>
            <h1>Contact Number</h1>
            <input className='w-80 rounded' name="contactNumber" value={formData.contactNumber} onChange={handleChange} />
          </div>
        </Col>
      </Row>
      <Row className="text-center py-20">
