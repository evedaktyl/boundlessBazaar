    ...
    try {
      ...
      const product = await prisma.products.create({
        data: {
          ...
          collect_country: productCountry,
          collect_state: productState,
          collect_city: productCity,
          deliver_country: deliveryCountry,
          deliver_state: deliveryState,
          deliver_city: deliveryCity,
          buyer_id: userID,
          status: "Listed",
          quantity: +quantity,
